...
public class HW05_02 {
    ...
    public static void main(String[] args) {
        ...
        String[] emploees = new String[] {"Иван Иванов", "Светлана Петрова", "Кристина Белова", "Анна Мусина", "Анна Крутова", "Иван Юрин", 
                                        "Петр Лыков", "Павел Чернов", "Петр Чернышев", "Мария Федорова", "Марина Светлова", "Мария Савина", 
                                        "Мария Рыкова", "Марина Луговая", "Анна Владимировна", "Иван Мечников", "Петр Петин", "Иван Ежов"};
